                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="nav-link" id="tab16" data-toggle="tab" href="#world-tab-16" role="tab" aria-controls="world-tab-16" aria-selected="false">Kesehatan</a>
                                    <a class="nav-link" id="tab17" data-toggle="tab" href="#world-tab-17" role="tab" aria-controls="world-tab-17" aria-selected="false">Politik</a>
                                </div>
                            </li>
                        </ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                        <!-- Post Thumbnail -->
                                                        <div class="post-thumbnail">
                                                            <img src="<?php echo base_url('asset/img/blog-img/b15.jpg')?>" alt="">
                                                        </div>
                                                        <!-- Post Content -->
                                                        <div class="post-content">
                                                            <a href="#" class="headline">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                        <!-- Post Thumbnail -->
                                                        <div class="post-thumbnail">
                                                            <img src="<?php echo base_url('asset/img/blog-img/b16.jpg')?>" alt="">
                                                        </div>
                                                        <!-- Post Content -->
                                                        <div class="post-content">
                                                            <a href="#" class="headline">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                        <!-- Post Thumbnail -->
                                                        <div class="post-thumbnail">
                                                            <img src="<?php echo base_url('asset/img/blog-img/b17.jpg')?>" alt="">
                                                        </div>
                                                        <!-- Post Content -->
                                                        <div class="post-content">
                                                            <a href="#" class="headline">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                        <!-- Post Thumbnail -->
                                                        <div class="post-thumbnail">
                                                            <img src="<?php echo base_url('asset/img/blog-img/b14.jpg')?>" alt="">
                                                        </div>
                                                        <!-- Post Content -->
                                                        <div class="post-content">
                                                            <a href="#" class="headline">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="single-blog-post">
                                        ...
                                        <div class="post-thumbnail">
                                            <img src="<?php echo base_url('asset/img/blog-img/b2.jpg')?>" alt="">
                                            <!-- Catagory -->
                                            <div class="post-cta"><a href="#">Kategori</a></div>
                                        </div>
                                        <!-- Post Content -->
                                        <div class="post-content">
                                            <a href="#" class="headline">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="single-blog-post">
                                        <!-- Post Thumbnail -->
                                        <div class="post-thumbnail">
                                            <img src="<?php echo base_url('asset/img/blog-img/b3.jpg')?>.jpg')?>" alt="">
                                            <!-- Catagory -->
                                            <div class="post-cta"><a href="#">Kategori</a></div>
                                        </div>
                                        <!-- Post Content -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="single-blog-post">
                                        <!-- Post Thumbnail -->
                                        <div class="post-thumbnail">
                                            <img src="<?php echo base_url('asset/img/blog-img/b3.jpg')?>" alt="">
                                            <!-- Catagory -->
                                            <div class="post-cta"><a href="#">Kategori</a></div>
                                        </div>
                                        <!-- Post Content -->
